      ...
      <div className="max-w-6xl mx-auto flex flex-wrap gap-6">
        ...
        <main className="flex-1 min-w-0">
          ...
          <div className="theme-card flex flex-wrap items-center justify-between shadow-lg p-6 my-6 rounded-2xl">
            ...
            <Link
              to="/"
              className="border border-blue-400/50 rounded-full px-4 py-2 text-blue-400 hover:bg-blue-400/10 dark:hover:bg-slate-800/10 hover:text-blue-500 transition-colors flex items-center gap-2 "
            >
              <HiHome /> Back to Home
            </Link>
          </div>
