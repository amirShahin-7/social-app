       ...
       <div className="flex justify-center gap-6">
          ...
          <main className="w-full max-w-2xl py-8 space-y-6">
            ...
            <div className="flex items-center gap-3 mt-8">
               ...
               <div className="flex-1 h-px bg-gradient-to-r from-blue-500/50 via-purple-500/30 to-transparent"></div>
            </div>
            ...
            {isError ? (
               <div className="flex justify-between items-center bg-slate-800/50 backdrop-blur-sm border border-red-500/30 rounded-2xl p-5">
                  ...
                  <Button
                     onPress={() => refetch()}
                     size="sm"
                     className="bg-gradient-to-r from-blue-500 to-cyan-500 text-white font-semibold shadow-lg shadow-blue-500/25"
