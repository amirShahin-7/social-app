  ...
  return (
    <Dropdown placement="bottom-end" className="mt-2">
      <DropdownTrigger>
        <div className="relative group">
          <Avatar
            ...
            radius="full"
            src={userData?.photo}
            fallback={<HiOutlineUser className="text-xl text-slate-400" />}
          />
      ...
      <DropdownMenu
        ...
        className="w-56 p-2 bg-slate-800/95 backdrop-blur-xl border border-white/10 rounded-xl shadow-xl"
      >
        <DropdownItem
          key="user-info"
          textValue="user info"
        ...
        <DropdownItem
          key="profile"
          textValue="profile"
          startContent={<HiOutlineUser className="text-lg text-blue-400" />}
